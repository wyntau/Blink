...
(function() {
  var Animate, DURATION, Pixel, RADIUS;

  window.Animate = Animate = (function() {
    ...
    */
    ...
    Animate.start = function(stepCallback, verifyCallback, completedCallback, duration, easingMethod) {
  ...
  window.EASEING_METHOD = {
    ...
    Bounce: {
      In: function(k) {
        return 1 - EASEING_METHOD.Bounce.Out(1 - k);
      },
      Out: function(k) {
        if (k < (1 / 2.75)) {
          return 7.5625 * k * k;
      ...
      InOut: function(k) {
        if (k < 0.5) {
          return EASEING_METHOD.Bounce.In(k * 2) * 0.5;
        } else {
          return EASEING_METHOD.Bounce.Out(k * 2 - 1) * 0.5 + 0.5;
        }
      }
    }
  };
  ...
  window.Pixel = Pixel = (function() {
    ...
    Pixel.prototype.setEaseingMethod = function(easingMethod) {
      ...
      this.easingMethod = ((_ref1 = EASEING_METHOD[section]) != null ? _ref1[mode] : void 0) || function(x) {
        return x;
      };
      return this;
    };
    ...
    Pixel.prototype.update = function() {
      ...
      if (spend <= this.duration) {
        this.R = this.fromR + this.toR * this.easingMethod(spend / this.duration);
      } else if ((this.duration <= spend && spend <= 2 * this.duration)) {
        this.R = this.fromR + this.toR * this.easingMethod((2 * this.duration - spend) / this.duration);
